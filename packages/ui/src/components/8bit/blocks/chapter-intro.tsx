...
import { Card, CardContent } from "@phena/ui/components/8bit/card";
        ...
        <div className={cn("relative w-full", heightClass)}>
          ...
          >
            <div className="mx-auto max-w-3xl">
              {chapter && (
                <h2 className="text-xl md:text-2xl lg:text-3xl font-bold leading-tight drop-shadow-[0_3px_0_rgba(0,0,0,0.8)] text-secondary/90">
                  {chapter}
                </h2>
              )}
              {title && (

...
import {
  ...
  AccordionItem,
  AccordionTrigger,
} from "@phena/ui/components/8bit/accordion";
...
import { ScrollArea } from "@phena/ui/components/8bit/scroll-area";
    ...
    >
      ...
      <AccordionContent className="px-4 pb-3">
        <div className="pt-2 space-y-3">
          ...
          {quest.serviceInfo && (
            <div className="bg-secondary/50 border-2 border-border p-3 rounded">
              <p className="text-[10px] font-medium text-primary mb-1">CONNECTION DETAILS</p>
              <div className="flex items-center gap-2 text-xs font-mono">
                <span className="text-muted-foreground">Host:</span>
                <span className="text-foreground">{quest.serviceInfo.host}</span>
              </div>
              <div className="flex items-center gap-2 text-xs font-mono">
                <span className="text-muted-foreground">Port:</span>
                <span className="text-foreground">{quest.serviceInfo.port}</span>
              </div>
            </div>
          )}
        </div>

...
import {
  ...
  AvatarFallback,
  AvatarImage,
} from "@phena/ui/components/8bit/avatar";
import { Badge } from "@phena/ui/components/8bit/badge";
import { Card, CardContent, CardHeader } from "@phena/ui/components/8bit/card";
import HealthBar from "@phena/ui/components/8bit/health-bar";
import ManaBar from "@phena/ui/components/8bit/mana-bar";
